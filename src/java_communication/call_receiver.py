...
The second argument is the message id. This id is used to load a file from the file system. The name of the file is the message id.
The function params for the called function are inside this file.
This script will call functions from the call_preprocessor module. There are functions defined that prepared and processes the Java data.
"""
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        raise Exception("This script only expects two params. The first param is the referenced function namen and the second the message id")
        sys.exit(1)
